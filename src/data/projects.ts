...
export const PROJECTS: Project[] = [
  {
    ...
    task: "Создать современное жилое пространство для семьи в историческом центре Москвы — без потери ощущения простора и воздуха в условиях сложной существующей планировки.",
    solution: "Снесены все ненесущие перегородки, выстроен новый план с единым дневным пространством. Палитра сведена к трём материалам: дуб, мрамор и штукатурка. Свет организован по трём сценариям — дневному, вечернему и рабочему.",
    result: "Квартира стала точным отражением образа жизни заказчиков: открытой, без лишних жестов, но с нужной глубиной. Пространство работает как единый организм.",
  ...
  },
  {
    ...
    task: "Проектирование интерьера загородного дома в сосновом лесу для семьи, вдохновлённой скандинавской архитектурой — с сохранением связи с природой и отказом от городской суеты.",
    solution: "Концепция строится на диалоге грубых фактур — сырого дерева и камня — с мягкостью льна и шерсти. Двусветная гостиная с панорамным остеклением превращает лес в часть интерьера. Тёплая система освещения имитирует естественный северный свет.",
    result: "Дом стал местом настоящего отдыха. Природные материалы с возрастом становятся только красивее — интерьер живёт и меняется вместе с хозяевами.",
